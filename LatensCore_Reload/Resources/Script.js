...
class Sprite extends GameObject {
    ...
    render() {
        ...
        else if(this.imageType === "addBackground"){
            let { x, y, width, height } = this.imageRect;
    
            this.game.context.drawImage(this.game.addback_image,
                x, y, width, height,
                (this.game.canvas.width/2 - this.game.player1.x + this.x) * UntitledGame.config.SCALE,
                (this.game.canvas.height/2 - this.game.player1.y + this.y) * UntitledGame.config.SCALE,
                width * UntitledGame.config.SCALE, height * UntitledGame.config.SCALE
        ...
        else if(this.imageType === "exp"){
            let { x, y, width, height } = this.imageRect;
    
            this.game.context.drawImage(this.game.Exp_image,
                x, y, width, height,
                (this.game.canvas.width/2 - this.game.player1.x + this.x) * UntitledGame.config.SCALE,
                (this.game.canvas.height/2 - this.game.player1.y + this.y) * UntitledGame.config.SCALE,
                width * UntitledGame.config.SCALE, height * UntitledGame.config.SCALE
...
class Background {
    ...
    addRuneGenerater() {
        const r1 = new Rune_Generater(this.game,1);
        const r2 = new Rune_Generater(this.game,2);
        const r3 = new Rune_Generater(this.game,3);
        const r4 = new Rune_Generater(this.game,4);
    ...
    addTnt(x, y) {
        ...
        const t3 = new Tnt(this.game);
        this.tnts.push(t3);
        t3.x = 1550; t3.y = 1200;

        const t4 = new Tnt(this.game);
        this.tnts.push(t4);
        t4.x = 1553; t4.y = 1330;

        const t5 = new Tnt(this.game);
        this.tnts.push(t5);
        t5.x = 520; t5.y = 1400;
        }
...
class SKULL extends Sprite{
    constructor(game){
        super(game, UntitledGame.spriteDefinition.SKULL,"addBackground");
    }
}
class SKULLS extends Sprite{
    constructor(game){
        super(game, UntitledGame.spriteDefinition.SKULLS,"addBackground");
    }
}
...
class Rune_Generater extends GameObject {
    constructor(game, pos) {
        ...
        this.runeSpawnTimer = UntitledGame.config.RUNE_RESPAWN;
    }
    ...
    addRune(){
        this.runes = [];
        const r = new Rune(this.game, this.pos, 0);
        this.runes.push(r);
        
        r.x = this.x + this.animation.width/2 + r.animation.width/5 * 2 - 10;
...
class Rune extends GameObject{
    constructor(game,pos, uploaded){
        super();
        this.game = game;
        this.pos = pos;
        this.useful = true;
        this.rune_type = getRandomInt(0,3);
        this.pos;
        this.uploaded = uploaded;
        this.up = true;
        this.limit=0;
        switch(this.rune_type){
            case 0: 
                this.Rune_type1 = new Sprite(game,UntitledGame.spriteDefinition.RUNE,"Bullet");
                this.animation = this.Rune_type1;
                this.x -= 10;
                this.y += 20;
                break;
            case 1 :  
                this.Rune_type2 = new Sprite(game,UntitledGame.spriteDefinition.RUNE2,"Bullet");
                this.animation = this.Rune_type2;
                this.x -= 10;
                this.y -= 5;
                break;
            case 2 :  
                this.Rune_type3 = new Sprite(game,UntitledGame.spriteDefinition.RUNE3,"Bullet");
                this.animation = this.Rune_type3;
                this.x -= 10;
                this.y += 5;
                break;
            case 3 :  
                this.Rune_type4 = new Sprite(game,UntitledGame.spriteDefinition.RUNE4,"Bullet");
                this.animation = this.Rune_type4;
                this.x -= 10;
                this.y += 5;
                break;
        }
        switch(this.pos){
            case 1 : this.game.rand1 = this.rune_type; break;
            case 2 : this.game.rand2 = this.rune_type; break;
            case 3 : this.game.rand3 = this.rune_type; break;
            case 4 : this.game.rand4 = this.rune_type; break;
        }
    }
    render(){
        this.animation.x = this.x;
    ...
    update(deltaTime) {
        ...
        switch(this.rune_type){
            case 0 : 
                if(this.animation != this.Rune_type1){
                    this.upload()
                }
                break;
            case 1 :  
            if(this.animation != this.Rune_type2){
                this.upload()
            }
                break;
            case 2 :  
            if(this.animation != this.Rune_type3){
                this.upload()
            }
                break;
            case 3 :  
            if(this.animation != this.Rune_type4){
                this.upload()
            }
                break;
        }
...
class Passive extends GameObject{
    constructor(game){
        ...
        this.game = game;
        this.useful = true;
        this.passive_type = getRandomInt(0,3);
        switch(this.passive_type){
            case 0 : 
...
class Bullet extends GameObject{
    ...
    update(deltaTime) {
        ...
        if((this.type == 0 || this.type == 2 ) && this.lifeTime > 0.7){
            ...
            if(this.owner == 1){
                if(this.rot == 0){
                    this.game.player1.y = this.y + 70;
                }
                else if(this.rot == 1){
                    this.game.player1.x = this.x - 70;
                }
                else if(this.rot == 2){
                    this.game.player1.y = this.y - 70;
                }
                ...
                if(this.rot == 0){
                    this.game.player2.y = this.y + 70;
                }
                else if(this.rot == 1){
                    this.game.player2.x = this.x - 70;
                }
                else if(this.rot == 2){
                    this.game.player2.y = this.y - 70;
                }
...
class Healthbar extends GameObject{
    ...
    render(){
        ...
        this.game.context.drawImage(this.game.UI_image,x, y, width, height,0,615,420,150);
    }
}
        ...
        if(this.owner == 1){
            this.game.context.drawImage(this.game.UI_image,
                x, y, width - (this.game.player1.limithp - this.game.player1.hp) * (200/this.game.player1.limithp * 2),
                 height,10,635,385 - (this.game.player1.limithp - this.game.player1.hp) * (385/this.game.player1.limithp),75);
        }
    }
}
class PassiveSlot extends GameObject{
    ...
    render(){
        let { x, y, width, height } = this.sprite.imageRect;
        this.game.context.drawImage(this.game.UI_image,x, y, width, height,765,620,width - 240,height - 120);
    }
}
class HotSlot extends GameObject{
    ...
    render(){
        let { x, y, width, height } = this.sprite.imageRect;
        this.game.context.drawImage(this.game.UI_image,x, y, width, height,985,622,width - 140,height - 85);
    }
}
...
class NowBullet extends GameObject {
    ...
    render(){
        ...
        this.game.context.drawImage(this.game.UI_image,x, y, width, height,986,630,width,height);
        ...
        this.game.context.fillText(this.game.bullet_name[this.game.player1.now_bullet], 1063,692);

        
        this.game.context.font = 'bold 22px 굴림';
        this.game.context.fillStyle = 'black';
        if(this.game.player1.inventory[this.game.player1.now_bullet]==0){
            this.game.context.fillText('∞', 1063, 661);
        }
        else if(this.game.player1.now_bullet != undefined){
            if(this.game.player1.count[this.game.player1.now_bullet] < 10){
                this.game.context.fillText(this.game.player1.count[this.game.player1.now_bullet], 1068, 663);
            }
            else{
                this.game.context.fillText(this.game.player1.count[this.game.player1.now_bullet], 1061, 663);
            }
        }
    }
}
class NowPassive extends GameObject {
    ...
    render(){
        this.sprite = this.nowpassive0;
        this.game.context.drawImage(this.game.passive_image,x, y, width, height,784,634,width,height);
        ...
        this.game.context.fillStyle = 'white';
        this.game.context.fillText(this.game.passive_name[this.game.player1.now_passive], 875, 685);
    }
}
...
class Player extends GameObject {
    ...
    update(deltaTime) {
        this.animation.update(deltaTime);
        this.collision();
        if(this.count != undefined && this.count[this.now_bullet] <= 0){
            this.now_bullet = 0;
        }
        ...
        if(this.game.isKeyStay('Escape') && this.game.delayEsc <= 0 && !this.game.stoped){
            if(!this.game.paused){
                screen = "setting";
        ...
        if(this.slowTime > 0){
            if(this.bulletSpawnTimer > UntitledGame.config.BULLET_RESPAWN * 1.6){
                this.attack = false;
                if(this.keyC && !this.isdead && this.count[this.now_bullet] > 0){
                    this.attack = true;
                    ...
                    if(this.inventory[this.now_bullet] >= 0 && this.inventory[this.now_bullet] <= 3){
                        ...
                        if(this.inventory[this.now_bullet] != 0){
                            this.count[this.inventory[this.now_bullet]]--;
                        }
                        b.owner = 1;
                ...
                if(this.keyC && !this.isdead && this.count[this.now_bullet] > 0){
                    ...
                    if(this.inventory[this.now_bullet] >= 0 && this.inventory[this.now_bullet] <= 3){
                        ...
                        if(this.inventory[this.now_bullet] == 2){
                            ...
                            b2.rot = this.rot + 8;
                            b1.type = this.inventory[this.now_bullet];
                            b1.owner = this.player_type;
                            b2.type = this.inventory[this.now_bullet];
                            b2.owner = this.player_type;
                        }
        ...
        if(this.game.isKeyStay('KeyV') && this.player_type == 1 && this.delayV <= 0){
            this.keyV = true;
        }
        else{
            this.keyV = false;
        ...
        if(this.game.isKeyStay('KeyC') && this.player_type == 1){
            this.keyC = true;
        }
        else{
            this.keyC = false;
    ...
    collision(){
        ...
        console.log("player1 : " + this.game.player1.now_passive)
        for(let obj of this.game.background.passivegeneraters){
            for(let obj_r of obj.passives){
                ...
                && (this.y + this.sprite.height > obj_r.y + 80 && this.y < obj_r.y + obj_r.animation.imageRect.height)){
                    //if (this.game.user == 1){
                        console.log("sibal : " + obj_r.passive_type)
                    switch(obj_r.passive_type){
                        case 0: this.now_passive = obj_r.passive_type; 
                            this.limithp = 7;
                            if(this.hp > 7){
                                this.hp = 7;
                            }
                        ...
                        case 2: 
                            ...
                            break;
                        case 3: this.now_passive = obj_r.passive_type;
                        this.limithp = 7;
                        if(this.hp > 7){
                            this.hp = 7;
                        } break;
...
class UntitledGame {
    constructor(canvasElement) {
        ...
        this.addback_image = new Image();
        this.addback_image.src = 'Resources/addBackground.png';
        ...
        this.Exp_image = new Image();
        this.Exp_image.src = 'Resources/Explosion.png';
    ...
    play() {
        bgm.volume = game.setting_bgm_volume
        bgm.play();
        this.paused = false;
        game.time = performance.now();
        game.scheduleNextUpdate();
    }
    ...
    render() {
        ...
        if(this.winner_screen){
            if(winner_ == 1){
                game.context.drawImage(this.Win,75,10);
            }
            else{
                game.context.drawImage(this.Lose,75,10);
            }
            screen = "Gameover"
        }
    }
    ...
    update(deltaTime) {
        ...
        for (let i in copyedUserObjects) {
            if (i != socket.id) {
                if(this.user == 1){
                    if(copyedUserObjects[i].nb2 != undefined){
                        this.player2.now_bullet = copyedUserObjects[i].nb2
                    }
                    else{
                        //this.player1.now_bullet = 0
                        console.log("sibla")
                    }
                }
            }
    ...
    socketUpdate() {
        for (let i in copyedUserObjects) {
            if (i == socket.id) {
                ...
                this.player2.x = copyedUserObjects[i].x
                this.player2.y = copyedUserObjects[i].y
                this.player2.rot = copyedUserObjects[i].r
                this.player2.keyC = copyedUserObjects[i].C
                this.player2.keyV = copyedUserObjects[i].V
                //this.base2.hp = copyedUserObjects[i].bh
                
                if(this.user == 2){
                    this.player2.hp = copyedUserObjects[i].h1
                    this.player1.hp = copyedUserObjects[i].h2
                    this.player1.limithp = copyedUserObjects[i].lh2
                    if(copyedUserObjects[i].i1 != undefined){
                        this.player2.count = copyedUserObjects[i].i1
                    }
                    if(copyedUserObjects[i].i2 != undefined){
                        this.player1.count = copyedUserObjects[i].i2
                    }
                    if(copyedUserObjects[i].np1 != undefined){
                        this.player2.now_passive = copyedUserObjects[i].np1
                    }
                    if(copyedUserObjects[i].np2 != undefined){
                        this.player1.now_passive = copyedUserObjects[i].np2
                    }

                    this.rand1 = copyedUserObjects[i].r1;
                    this.rand2 = copyedUserObjects[i].r2;
                    this.rand3 = copyedUserObjects[i].r3;
                    this.rand4 = copyedUserObjects[i].r4;
                    for(let obj of this.background.runegeneraters){
                        for(let obj_r of obj.runes){
                            switch(obj_r.pos){
                                case 1: obj_r.rune_type = this.rand1; obj_r.upload(this.rand1); break;
                                case 2: obj_r.rune_type = this.rand2; obj_r.upload(this.rand2); break;
                                case 3: obj_r.rune_type = this.rand3; obj_r.upload(this.rand3); break;
                                case 4: obj_r.rune_type = this.rand4; obj_r.upload(this.rand4); break;
                            }
                        }
                    }
        ...
        if(this.user == 1){
            socket.emit("update", {
                ...
                h1: this.player1.hp,
                h2: this.player2.hp,
                lh2: this.player2.limithp,
                bh: this.base1.hp,
                i1: this.player1.count,
                i2: this.player2.count,
                np1: this.player1.now_passive,
                np2: this.player2.now_passive,
                r1: this.rand1,
                r2: this.rand2,
                r3: this.rand3,
                r4: this.rand4,
...
UntitledGame.spriteDefinition = {
    ...
    SKULL: new Rect(167, 435, 33, 70),
    SKULLS: new Rect(25, 420, 60, 80),
    ...
    HOTSLOT: new Rect(0.65, 515, 390, 220),
...
socket.on('matching', (event) => { //매칭 됨
    ...
    if (event.player === 1) {
        ...
        game.player2.rot = 3
        game.player2.player_type = 2

        game.base1 = new Base(game);
        game.base2 = new Base(game);
        game.bases.push(game.base1);
        game.bases.push(game.base2);
        game.base1.owner = 1;
        game.base2.owner = 2;
        game.base1.x = 100; game.base1.y = 860;
        game.base2.x = 2270; game.base2.y = 860;
    }
    else {
        game.user = 2;
        game.player1 = new Player(game);
        ...
        game.base1.owner = 1;
        game.base2.owner = 2;
        game.base1.x = 2270; game.base1.y = 860;
        game.base2.x = 100; game.base2.y = 860;
    }
...
window.onload = function () {
    ...
    Disconnected.src = 'Resources/Disconnected.png';
    loading1 = new Image();
    loading1.src = 'Resources/Loading1.png';
    loading2 = new Image();
    loading2.src = 'Resources/Loading2.png';
    loading3 = new Image();
    loading3.src = 'Resources/Loading3.png';
