...
class Rune extends GameObject{
    constructor(game){
        ...
        this.game = game;
        this.useful = true;
        this.rune_type = getRandomInt(1,4);
...
class Passive extends GameObject{
    constructor(game){
        ...
        this.game = game;
        this.useful = true;
        this.passive_type = getRandomInt(1,4);
...
class UntitledGame {
    ...
    socketUpdate() {
        ...
        for (let i in copyedUserObjects) {
            if(this.background.passivegeneraters[0].passives[0] != null && this.user == 2){
                this.background.passivegeneraters[0].passives[0].passive_type = copyedUserObjects[i].P;
                this.background.passivegeneraters[0].passives[0].upload();
            }
            if(this.background.runegeneraters[0].runes[0] != null && this.user == 2){
                this.background.runegeneraters[0].runes[0].rune_type = copyedUserObjects[i].r1;
                this.background.runegeneraters[0].runes[0].upload();
                this.background.runegeneraters[1].runes[0].rune_type = copyedUserObjects[i].r2;
                this.background.runegeneraters[1].runes[0].upload();
                this.background.runegeneraters[2].runes[0].rune_type = copyedUserObjects[i].r3;
                this.background.runegeneraters[2].runes[0].upload();
                this.background.runegeneraters[3].runes[0].rune_type = copyedUserObjects[i].r4;
                this.background.runegeneraters[3].runes[0].upload();
                console.log(copyedUserObjects[i].r1)
            }
            if (i == socket.id) {
            }
            else {
        ...
        if(this.background.passivegeneraters[0].passives[0] != null && this.user == 1){
            socket.emit("update", {
                P: this.background.passivegeneraters[0].passives[0].passive_type,
            })
        }
        if(this.background.runegeneraters[0].runes[0] != null && this.user == 1){
            socket.emit("update", {
                r1: this.background.runegeneraters[0].runes[0].rune_type,
                r2: this.background.runegeneraters[1].runes[0].rune_type,
                r3: this.background.runegeneraters[2].runes[0].rune_type,
                r4: this.background.runegeneraters[3].runes[0].rune_type,
        })}
    }
    }
