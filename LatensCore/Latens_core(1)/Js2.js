    ...
    render() {
        if(this.imageType === "Bullet"){
            ...
            this.game.context.drawImage(this.game.bullet_image,
                x, y, width, height,
                this.game.canvas.width/2 - this.game.player1.x + this.x, this.game.canvas.height/2 - this.game.player1.y + this.y, width, height
            );
            this.game.context2.drawImage(this.game.bullet_image,
                x, y, width, height,
                this.game.canvas.width/2 - this.game.player2.x + this.x, this.game.canvas.height/2 - this.game.player2.y + this.y, width, height
            );
        }
            ...
            this.game.context.drawImage(this.game.Player_image,
                x, y, width, height,
                this.game.canvas.width/2 - this.imageRect.width/2, this.game.canvas.height/2 - this.imageRect.height/2, width, height
            );
            this.game.context2.drawImage(this.game.Player_image,
                x, y, width, height,
                this.game.canvas.width/2 - this.game.player2.x - this.imageRect.width/2 + this.x, this.game.canvas.height/2 - this.game.player2.y - this.imageRect.height   /2 + this.y, width, height
            );
        }
            ...
            this.game.context.drawImage(this.game.Player2_image,
                x, y, width, height,
                this.game.canvas.width/2 - this.game.player1.x - this.imageRect.width/2 + this.x, this.game.canvas.height/2 - this.game.player1.y - this.imageRect.height/2 + this.y, width, height
            );
            this.game.context2.drawImage(this.game.Player2_image,
                x, y, width, height,
                this.game.canvas.width/2 - this.imageRect.width/2, this.game.canvas.height/2 - this.imageRect.height/2, width, height
            );
        }
            ...
            this.game.context2.drawImage(this.game.back_image,
                x, y, width, height,
                this.game.canvas.width/2 - this.game.player2.x + this.x, this.game.canvas.height/2 - this.game.player2.y + this.y, width, height
            );
        }
            ...
            this.game.context2.drawImage(this.game.effect_image,
                x, y, width, height,
                this.game.canvas.width/2 - this.game.player2.x + this.x, this.game.canvas.height/2 - this.game.player2.y + this.y, width, height
            );
        }
            ...
            this.game.context2.drawImage(this.game.passive_image,
                x, y, width, height,
                this.game.canvas.width/2 - this.game.player2.x + this.x, this.game.canvas.height/2 - this.game.player2.y + this.y, width, height
            );
        }
            ...
            this.game.context2.drawImage(this.game.UI_image,
                x, y, width, height,
                this.game.canvas.width/2 - this.game.player2.x + this.x, this.game.canvas.height/2 - this.game.player2.y + this.y, width, height
            );
        }
            ...
            this.game.context2.drawImage(this.game.gateImage,
                x, y, width, height,
                this.game.canvas.width/2 - this.game.player2.x + this.x, this.game.canvas.height/2 - this.game.player2.y + this.y, width, height
            );
        }
            ...
            this.game.context2.drawImage(this.game.base_image,
                x, y, width, height,
                this.game.canvas.width/2 - this.game.player2.x + this.x, this.game.canvas.height/2 - this.game.player2.y + this.y, width, height
            );
        }
...
class Background {
    ...
    addWall(){
        ...
        // for(var i = 1 ;i<6;i++){
        //     p = new WALLSHADOW(this.game); 
        //     this.floors.push(p);
        //     p.x = 209 + 102.75 * i; p.y = 777.5
        // }
        ...
        //     p = new WALLSHADOW(this.game); 
        //     this.floors.push(p);
        //     p.x = 2168 + 102.75 * -i; p.y = 777.5
        // }
        // p = new VERTICALSHADOW(this.game); 
        // this.floors.push(p);
        // p.x = 1641; p.y = 779

        // p = new WALLSHADOW2(this.game); 
        // this.floors.push(p);
        // p.x = 2168 + 102.75 * -5; p.y = 777.5
        ...
        //     p = new WALLSHADOW(this.game); 
        //     this.floors.push(p);
        //     p.x = 2168 + 102.75 * -i; p.y = 1152.5
        // }
        // p = new WALLSHADOW2(this.game); 
        // this.floors.push(p);
        // p.x = 2168 + 102.75 * -5; p.y = 1152.5
...
class Healthbar extends GameObject{
    ...
    render(){
        ...
        this.game.context2.drawImage(this.game.UI_image,x, y, width, height,0,665,220,80);
    }
}
class Health extends GameObject{
    ...
    render(){
        ...
        if(this.owner == 1){
            ...
            this.game.context2.drawImage(this.game.UI_image,
                x, y, width - (this.game.player2.limithp - this.game.player2.hp) * (200/this.game.player2.limithp * 2),
                 height,5,670,200 - (this.game.player2.limithp - this.game.player2.hp) * (200/this.game.player2.limithp),45);
        }
    }
}
class PassiveSlot extends GameObject{
    ...
    render(){
        ...
        this.game.context2.drawImage(this.game.UI_image,x, y, width, height,435,620,width - 240,height - 120);
    }
}
class HotSlot extends GameObject{
    ...
    render(){
        ...
        this.game.context2.drawImage(this.game.UI_image,x, y, width, height,0,-18,width - 140,height - 85);
    }
}
...
class NowBullet extends GameObject {
    ...
    render(){
        ...
        var { x, y, width, height } = this.sprite.imageRect;
        this.game.context2.drawImage(this.game.UI_image,x, y, width, height,0,0,width,height);
        
        this.game.context.font = 'bold 22px 굴림';
        this.game.context.fillStyle = 'white';
        this.game.context2.font = 'bold 22px 굴림';
        this.game.context2.fillStyle = 'white';
        this.game.context.fillText(this.game.bullet_name[this.game.player1.now_bullet], 80, 60);
        this.game.context2.fillText(this.game.bullet_name[this.game.player2.now_bullet], 80, 60);

        
        this.game.context.font = 'bold 22px 굴림';
        this.game.context.fillStyle = 'black';
        this.game.context2.font = 'bold 22px 굴림';
        this.game.context2.fillStyle = 'black';
        ...
        if(this.game.player2.inventory[this.game.player2.now_bullet]==0){
            this.game.context2.fillText('∞', 82, 31);
        }
        else{
            if(this.game.player2.count[this.game.player2.now_bullet] < 10){
                this.game.context2.fillText(this.game.player2.count[this.game.player2.now_bullet], 85, 31);
            }
            else{
                this.game.context2.fillText(this.game.player2.count[this.game.player2.now_bullet], 78, 31);
            }
        }
    }
}
class NowPassive extends GameObject {
    ...
    render(){
        ...
        var { x, y, width, height } = this.sprite.imageRect;
        this.game.context2.drawImage(this.game.passive_image,x, y, width, height,454,634,width,height);
        
        this.game.context.font = 'bold 28px 맑은고딕';
        this.game.context.fillStyle = 'white';
        this.game.context2.font = 'bold 28px 맑은고딕';
        this.game.context2.fillStyle = 'white';
        this.game.context.fillText(this.game.passive_name[this.game.player1.now_passive], 555, 685);
        this.game.context2.fillText(this.game.passive_name[this.game.player2.now_passive], 555, 685);
    }
}
...
class Player extends GameObject {
    ...
    update(deltaTime) {
        ...
        if(this.respawnTime > 0){
            ...
            if(this.respawnTime < 3.5){
                if(this.player_type == 1){
                    if(this.x > this.game.base1.sprite.x + 10){
                        this.x-= 10
                    }
                    else if(this.x < this.game.base1.sprite.x - 10){
                        this.x += 10
                    }
                    else{
                        this.x = this.game.base1.sprite.x;
                    }
                    if(this.y > this.game.base1.sprite.y + 10){
                        this.y -= 10
                    }
                    else if(this.y < this.game.base1.sprite.y - 10){
                        this.y += 10
                    }
                    else{
                ...
                if(this.player_type == 2){
                    if(this.x > this.game.base2.sprite.x + 10){
                        this.x-= 10
                    }
                    else if(this.x < this.game.base2.sprite.x - 10){
                        this.x += 10
                    }
                    else{
                        this.x = this.game.base2.sprite.x;
                    }
                    if(this.y > this.game.base2.sprite.y + 10){
                        this.y -= 10
                    }
                    else if(this.y < this.game.base2.sprite.y - 10){
                        this.y += 10
                    }
                    else{
        ...
        if (this.game.isKeyStay('ArrowUp') && this.player_type == 2 && !this.isdead) {
            if(this.up_clear){
                if(this.slowTime > 0){
                    this.y -= this.speed * 0.5;
                }
        ...
        else if(this.game.isKeyStay('ArrowDown') && this.player_type == 2 && !this.isdead){
            if(this.down_clear){
                if(this.slowTime > 0){
                    this.y += this.speed * 0.5;
                }
        ...
        if(this.game.isKeyStay('ArrowLeft') && this.player_type == 2 && !this.isdead){
            if(this.left_clear){
                if(this.slowTime > 0){
                    this.x -= this.speed * 0.5;
                }
        ...
        else if(this.game.isKeyStay('ArrowRight') && this.player_type == 2 && !this.isdead){
            if(this.right_clear){
                if(this.slowTime > 0){
                    this.x += this.speed * 0.5;
                }
        ...
        if(this.game.isKeyStay('KeyV') && this.player_type == 1 && this.delayV <= 0 && !this.isdead){
            ...
            console.log("now bullet : " + this.inventory[this.now_bullet]);
            console.log("now : " + this.now_bullet);
        }
        if(this.game.isKeyStay('Slash') && this.player_type == 2 && this.delayK <= 0 && !this.isdead){
            this.now_bullet++
            this.delayK = 0.2;
            while(this.count[this.now_bullet] == 0){
                this.now_bullet++;
        ...
        if(this.bulletSpawnTimer > UntitledGame.config.BULLET_RESPAWN){
            ...
            if(this.game.isKeyStay('Enter') && this.player_type == 2 && !this.isdead){
                ...
                if(this.inventory[this.now_bullet] >= 0 && this.inventory[this.now_bullet] <= 3){
                    ...
                    if(this.inventory[this.now_bullet] != 0){
                        this.inven_remove(this.inventory[this.now_bullet])
                        console.log(this.inventory[this.now_bullet])
                    }
                    b.owner = 2;
    ...
    inven_remove(item){
        this.count[item]--;
        console.log("inven : " + this.inventory);
        console.log("cont : " + this.count);
    }

    collision(){
        for(let obj of this.game.player1.bullets){
            if((this.x + this.sprite.width - 50 > obj.x + 10 && this.x - 50 < obj.x + obj.animation.imageRect.width - 10)
            && (this.y + this.sprite.height - 50 > obj.y + 10 && this.y - 50 < obj.y + obj.animation.imageRect.height - 10)){
                if(this.player_type != obj.owner && obj.lifeTime == 0){
                    ...
                    if(this.inventory[this.now_bullet] != 4){
                        ...
                        if(this.hp <= 0){
                            ...
                            console.log(this.game.base2.hp)
                ...
                if(this.player_type != obj.owner && obj.lifeTime == 0){
                    ...
                    if(this.inventory[this.now_bullet] != 4){
                        ...
                        if(this.hp <= 0){
                            ...
                            console.log(this.game.base1.hp)
        ...
        for(let obj of this.game.player1.bullets){
            ...
            && (this.game.base2.sprite.y + this.game.base2.sprite.height > obj.y && this.game.base2.sprite.y < obj.y + obj.animation.imageRect.height)){
        ...
        for(let obj of this.game.player2.bullets){
            ...
            && (this.game.base1.sprite.y + this.game.base1.sprite.height > obj.y && this.game.base1.sprite.y < obj.y + obj.animation.imageRect.height)){
        ...
        for(let obj of this.game.background.gates){
            if((this.x + this.sprite.width - 50 > obj.x && this.x - 50 < obj.x + obj.sprite.width)
            && (this.y + this.sprite.height - 150 > obj.y && this.y - 80 < obj.y + obj.sprite.height)){
        ...
        for(let obj of this.game.background.runegeneraters){
            for(let obj_r of obj.runes){
                if((this.x + this.sprite.width > obj_r.x && this.x < obj_r.x + obj_r.animation.imageRect.width)
                && (this.y + this.sprite.height > obj_r.y && this.y < obj_r.y + obj_r.animation.imageRect.height)){
                    let i;
                    for(i=0;i<5;i++){
                        console.log(obj_r.rune_type)
            ...
            for(let obj_r of obj.passives){
                ...
                && (this.y + this.sprite.height > obj_r.y && this.y < obj_r.y + obj_r.animation.imageRect.height)){
                    switch(obj_r.passive_type){
                        ...
                        case 2: this.now_passive = obj_r.passive_type; this.limithp = 12; this.hp += 5; 
                            if(this.hp > 12){
                                this.hp = 12;
                            }
                            break;
                        case 3: 
                            if(this.player_type == 1){
                                ...
                                this.game.player1.now_passive = 0;
                            }
                            break;
    ...
    gameover(winner){
        winner_ = winner;
        console.log("GameOver, Winner : " + winner_);
        ...
        function start(counter){
            if(counter < 25){
                setTimeout(function(){
                    ...
                    game.context2.translate(-320 * 0.01,-360 * 0.01);
                    game.context2.scale(1.01,1.01);
                    start(counter);
                }, 30);
            }
            else if(counter < 28){
...
class UntitledGame {
    constructor(canvasElement, canvasElement2) {
        this.canvas = canvasElement;
        this.context = canvasElement.getContext('2d');
        this.canvas2 = canvasElement2;
        this.context2 = canvasElement2.getContext('2d');
        ...
        this.Stroke.src = 'Resources/Stroke.png';
        ...
        this.player2.player_type = 2;

        
        this.player1.upS = new Animation(this,UntitledGame.spriteDefinition.PLAYERUP,"Player1", 1, 1);
        this.player1.rightS = new Animation(this,UntitledGame.spriteDefinition.PLAYERRIGHT,"Player1",  1, 1);
        this.player1.downS = new Animation(this,UntitledGame.spriteDefinition.PLAYERDOOWN,"Player1",  1, 1);
        this.player1.leftS = new Animation(this,UntitledGame.spriteDefinition.PLAYERLEFT,"Player1",  1, 1);

        this.player1.up = new Animation(this,UntitledGame.spriteDefinition.PLAYERUP,"Player1", 1, 2);
        this.player1.right = new Animation(this,UntitledGame.spriteDefinition.PLAYERRIGHT,"Player1",  1, 2);
        this.player1.down = new Animation(this,UntitledGame.spriteDefinition.PLAYERDOOWN,"Player1",  1, 2);
        this.player1.left = new Animation(this,UntitledGame.spriteDefinition.PLAYERLEFT,"Player1",  1, 2);

        this.player1.upA = new Line(this,UntitledGame.spriteDefinition.PLAYERUP,"Player1", 4, 10);
        this.player1.rightA = new Line(this,UntitledGame.spriteDefinition.PLAYERRIGHT,"Player1",  4, 10);
        this.player1.downA = new Line(this,UntitledGame.spriteDefinition.PLAYERDOOWN,"Player1",  4, 10);
        this.player1.leftA = new Line(this,UntitledGame.spriteDefinition.PLAYERLEFT,"Player1",  4, 10);

        
        this.player2.upS = new Animation(this,UntitledGame.spriteDefinition.PLAYERUP,"Player2", 1, 1);
        this.player2.rightS = new Animation(this,UntitledGame.spriteDefinition.PLAYERRIGHT,"Player2",  1, 1);
        this.player2.downS = new Animation(this,UntitledGame.spriteDefinition.PLAYERDOOWN,"Player2",  1, 1);
        this.player2.leftS = new Animation(this,UntitledGame.spriteDefinition.PLAYERLEFT,"Player2",  1, 1);

        this.player2.up = new Animation(this,UntitledGame.spriteDefinition.PLAYERUP,"Player2", 1, 2);
        this.player2.right = new Animation(this,UntitledGame.spriteDefinition.PLAYERRIGHT,"Player2",  1, 2);
        this.player2.down = new Animation(this,UntitledGame.spriteDefinition.PLAYERDOOWN,"Player2",  1, 2);
        this.player2.left = new Animation(this,UntitledGame.spriteDefinition.PLAYERLEFT,"Player2",  1, 2);

        this.player2.upA = new Line(this,UntitledGame.spriteDefinition.PLAYERUP,"Player2", 4, 10);
        this.player2.rightA = new Line(this,UntitledGame.spriteDefinition.PLAYERRIGHT,"Player2",  4, 10);
        this.player2.downA = new Line(this,UntitledGame.spriteDefinition.PLAYERDOOWN,"Player2",  4, 10);
        this.player2.leftA = new Line(this,UntitledGame.spriteDefinition.PLAYERLEFT,"Player2",  4, 10);
    ...
    render() {
        ...
        this.context.drawImage(this.Stroke,637,-5);
        this.context2.drawImage(this.Stroke,-8,-5);


        if(this.settingBool){
            this.context.drawImage(this.Setting,0,0,700,820,200,50,590,620);
            this.context2.drawImage(this.Setting,522,0,700,820,0,50,590,620);//설정창 띄우기
        ...
        if(this.winner_screen){
            if(winner_ == 1){
                ...
                game.context2.drawImage(this.Lose,78,100,500,500);
            }
            else{
                game.context.drawImage(this.Lose,78,100,500,500);
                game.context2.drawImage(this.Win,78,100,500,500);
            }
            screen = "Gameover"
        }
    }
...
let gameCanvas2 = document.getElementById('game2');
let game = new UntitledGame(gameCanvas,gameCanvas2);
var bar = new Image();
var winner_ = 1
